                          ...
                          <div className="login-main add-list">
                            ...
                            <div className="log add-list-map">
                              <div className="login add-list-map">
                                ...
                                <div class="row">
                                <div className="col-md-6">
                                    <button onClick={()=>handleStepClick(3)} type='button'  className="btn btn-primary">Previous</button>
                                </div>
                                <div className="col-md-6">
                                  <button onClick={()=>handleStepClick(5)} type='button'   className="btn btn-primary">Next</button>
                                </div>
                              </div>
                                {/*FILED END*/}
                              </div>
