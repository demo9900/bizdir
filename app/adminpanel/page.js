...
const page = () => {
  ...
  <div className="ad-head">
    <div className="head-s1">
      <div className="menu">
        {" "}
        <i className="material-icons mopen">menu</i>y
...
<section>
  <div className="ad-menu-lhs mshow">
    <div className="ad-menu">
      <ul>
        <li className="ic-db">
          {" "}
          <a href="profile.html" className="mact">
            Dashboard
          </a>
        </li>
        <li className="ic-seo">
          ...
          <div>
            <h4>
              ...
              <div className="ttip-com">
                ...
                <div>
                  This can help you to index your category pages with rich
                  results. You can change meta title, descriptions, keywords,
                  Short description about your category, FAQ and google
                  schema(rating, faq and more) for every category.
                </div>
              </div>
              {/* END */}
            </h4>
            ...
            <h4>
              ...
              <div className="ttip-com">
                <i className="material-icons">priority_high</i>
                <div>
                  You can create particular targeting pages with your favorite
                  listing. This can be helping for end-users can get accurate
                  results, get more leads, target every small area with google
                  rich results, and more.
                </div>
              </div>
              {/* END */}
            </h4>
            ...
            <h4>
              ...
              <div className="ttip-com">
                <i className="material-icons">priority_high</i>
                <div>
                  You can create general blog pages with your favorite listing,
                  events, products, blogs with enquiry form. This page can help
                  you go get more leads and google index.
                </div>
              </div>
              {/* END */}
            </h4>
            ...
            <h4>
              ...
              <div className="ttip-com">
                <i className="material-icons">priority_high</i>
                <div>
                  These pages can help you to promote a product, listing and
                  digital assets with enquiry form, you can get quality leads
                  and more.
                </div>
              </div>
              {/* END */}
        ...
        <li className="ic-pay">
          {" "}
          <a className="" href="admin-all-payments.html">
            All Payments
          </a>
        </li>
        <li className="ic-coup">
          {" "}
          <a href="#" className="">
            Coupon and deals
          </a>
        ...
        <li className="ic-txt">
          {" "}
          <a className="" href="admin-text-changes.html">
            All Text Changes
          </a>
        </li>
        <li className="ic-pri">
          {" "}
          <a className="" href="admin-price.html">
            Pricing Plans
          </a>
        </li>
        <li className="ic-pay">
          {" "}
          <a className="" href="admin-payment-credentials.html">
            Payment gateway
          </a>
        </li>
        <li className="ic-set">
          {" "}
          <a className="" href="admin-setting.html">
            Setting
          </a>
        </li>
        <li className="ic-act">
        ...
        <li className="ic-addon">
          {" "}
          <a href="addons.html" className="">
            Add-ons
          </a>
        </li>
        <li className="ic-dum">
          {" "}
          <a className="" href="admin-dummy-images.html">
            Dummy Images
          </a>
        </li>
        ...
        <li className="ic-soci">
          {" "}
          <a href="admin-social-share.html" className="">
            Social media share
          </a>
        </li>
        <li className="ic-set">
          {" "}
          <a href="admin-security-updates.html" className="">
