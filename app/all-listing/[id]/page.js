        ...
        <>
                ...
                <div className="row">
                  <div className="v3-list-ql-inn">
                    <ul>
                      ...
                      <li
                        className={
                          activeSection === "offer" ? "active-list" : ""
                        }
                      ...
                      >
                        <span>
                          <i className="material-icons">star_half</i> Write
                          Review
                        </span>
                      </li>
                      {/* <li>
              ...
              <div className="row">
                <div className="com-padd">
                  ...
                  >
                      ...
                      <div className="list-pg-inn-sp">
                        <div className="home-list-pop">
                          ...
                          <div className="col-md-9 home-list-pop-desc inn-list-pop-desc list-room-deta">
                            ...
                            <p>
                              Special booking March offer It is a long
                    ...
                    {/*LISTING DETAILS: LEFT PART 5*/}
                    <div
                      className="pglist-p3 pglist-bg pglist-p-com"
                      id="ld-rev"
                    >
                      <div className="pglist-p-com-ti">
                        <h3>
                          ...
                          <ul>
                            <li>
                              ...
                              <div className="lr-user-wr-con">
                                ...
                                <span className="lr-revi-date">
                                  07, Mar 2021
                                </span>
                                <p>
                                  verified_userRolexo Villas is well-known to
                                  all as a premier builder of villas and
                                  apartments. Even though they have various
                                  departments they stay united in giving the
                                  customers the best service. I really had a
                                  good service right from on time delivery,
                                  quality of work, perfection in work
                                  completion. The relationship does not end in
                                  just in hand over but they stand strong in all
                                  tuff times for the commitment given. After 3+
                                  years of handover they addressed the compound
          ...
          <section>
            <div className="pop-ups pop-quo">
              ...
              {/* The Modal */}
              <div className={`modal fade ${claimModal ? 'show':''}`} style={{display:`${claimModal ? 'block':'none'}`,  paddingRight:`${claimModal? '15px':'0'}`}} id="claim">
                <div className="modal-dialog">
                  <div className="modal-content">
                    <div className="log-bor">&nbsp;</div>
