        ...
        <div className="container">
          <div className="row">
            <div className="login-main add-list posr">
              ...
              <span className="udb-inst">new post</span>
              <div className="log log-1">
                <div className="login">
                  <h4>Create post</h4>
                  <form name="blog_form" id="blog_form" method="post" action="insert_blog.html" encType="multipart/form-data">
                    <ul>
                      <li>
                        {/*FILED START*/}
                        <div className="row">
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" name="blog_name" required="required" className="form-control" placeholder="Post name *" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <textarea name="blog_description" id="blog_description" required="required" className="form-control" placeholder="Post details" defaultValue={""} />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              ...
                              <input type="file" name="blog_image" required="required" className="form-control" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div>
                              <div className="chbox">
                                <input type="checkbox" name="isenquiry" id="evefmenab" defaultChecked />
                                <label htmlFor="evefmenab">Enquiry or Get quote form enable</label>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <button type="submit" name="blog_submit" className="btn btn-primary">Submit</button>
                      </div>
                    </div>
                    {/*FILED END*/}
                  </form>
