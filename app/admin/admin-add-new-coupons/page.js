            ...
            <div className="login-main add-list add-ncate">
              ...
              <div className="log log-1">
                <div className="login">
                  ...
                  <form name="coupon_form" id="coupon_form" encType="multipart/form-data" method="post" action="insert_coupon.html" className="cre-dup-form cre-dup-form-show">
                    <ul>
                      <li>
                        {/*FILED START*/}
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <select name="coupon_user_id" required="required" className="form-control" id="coupon_user_id">
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" className="form-control" name="coupon_name" placeholder="Coupon name" required />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" className="form-control" name="coupon_code" placeholder="Offer code" required />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" className="form-control" name="coupon_link" placeholder="Website link(if online offer)" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                          ...
                          <div className="col-md-12">
                            <div className="form-group">
                              <label>Brand logo or Offer image(Recommended size 65 X
                                65)</label>
                              <input type="file" required="required" name="coupon_photo" className="form-control" placeholder="Offer image" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              ...
                              <input type="date" className="form-control" name="coupon_start_date" required />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-group">
                              <label>End date</label>
                              <input type="date" className="form-control" name="coupon_end_date" required />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                    ...
                    <button type="submit" name="coupon_submit" className="btn btn-primary">Submit
                    </button>
                  </form>
                </div>
              </div>
