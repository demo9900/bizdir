        ...
        <div className="container">
          <div className="row">
            <div className="login-main add-list posr">
              ...
              <span className="udb-inst">new event</span>
              <div className="log log-1">
                <div className="login">
                  <h4>Create Event</h4>
                  <form name="event_form" id="event_form" method="post" action="insert_event.html" encType="multipart/form-data">
                    <ul>
                      <li>
                        {/*FILED START*/}
                        <div className="row">
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" name="event_name" required="required" className="form-control" placeholder="Event name *" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <input type="text" name="event_address" required="required" className="form-control" placeholder="Address *" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="date" name="event_start_date" required="required" className="form-control" placeholder="Date *" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="text" name="event_time" required="required" className="form-control" placeholder="Time *" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <textarea className="form-control" required="required" id="event_description" name="event_description" placeholder="Event details" defaultValue={""} />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              <textarea className="form-control" name="event_map" placeholder="Google map location" defaultValue={""} />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div className="form-group">
                              ...
                              <input type="file" name="event_image" required="required" className="form-control" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="text" name="event_contact_name" required="required" className="form-control" placeholder="Contact person *" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="text" name="event_mobile" required="required" className="form-control" placeholder="Contact phone number *" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="email" name="event_email" required="required" className="form-control" placeholder="Contact Email Id *" />
                            </div>
                          </div>
                          <div className="col-md-6">
                            <div className="form-group">
                              <input type="text" name="event_website" className="form-control" placeholder="Event Website" />
                            </div>
                          </div>
                        </div>
                        {/*FILED END*/}
                        ...
                        <div className="row">
                          <div className="col-md-12">
                            <div>
                              <div className="chbox">
                                <input type="checkbox" id="isenquiry" name="isenquiry" defaultChecked />
                                <label htmlFor="isenquiry">Enquiry or Registration form enable</label>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="row">
                      <div className="col-md-12">
                        <button type="submit" name="event_submit" className="btn btn-primary">Submit</button>
                      </div>
                    </div>
                    {/*FILED END*/}
                  </form>
