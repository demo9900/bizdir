...
export default function DashboardLayout({
    ...
    const path = ['/account/add-listing-start','/account/add-listing-step-1','/account/add-listing-step-2','/account/add-listing-step-3','/account/add-listing-step-4','/account/add-listing-step-5','/account/add-listing-step-6']
  ...
  <div className="str">
    ...
    <>
   {!path.includes(pathname)? ( <section className=" ud">
