    ...
    <div className="ud-inn">
      ...
      <div className="ud-lhs">
        ...
        <div className="ud-lhs-s2">
          <ul>
            ...
            <li>
              <Link href="/db-post-ads" className="db-lact">
      ...
      <div className="ud-cen">
        ...
        <div className="ud-cen-s2">
          ...
          <Link href="/post-your-ads" className="db-tit-btn db-tit-btn-2-ads">
            Post your Ads
          </Link>
          <Link href="/ad-details" className="db-tit-btn">
          ...
          <table className="responsive-table bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>0 Days</td>
                <td>
                  <span className="db-list-ststus">InActive</span>
                </td>
                <td>
                  <span className="db-list-rat">1k</span>
                </td>
                <td>
                  <span className="db-list-rat">642</span>
                </td>
              </tr>
              <tr>
                <td>2</td>
